...
![Projekteigenschaften](/giscurriculum/images/de/module6/media/gen-settings.png "Projekteigenschaften")

Abbildung 6.4: Projekteigenschaften

5. Klicken Sie anschließend auf die Schaltfläche **Feldrechner öffnen** ![alt_text](/giscurriculum/images/de/module6/media/field_calculator.png "image_tooltip") in der Symbolleiste Attribute, um den Feldrechner zu öffnen. Der Dialog des Feldrechners wird geöffnet; geben Sie den Namen des Ausgabefeldes ein, in diesem Fall 'FLÄCHE (QKM)'. Wählen Sie die Dezimalzahl (real) als Ausgabefeldtyp. Ändern Sie die Genauigkeit auf 2 Dezimalstellen. Um die Fläche zu berechnen, verwenden Sie den folgenden Ausdruck:
...
![Feldrechner-Dialog](/giscurriculum/images/de/module6/media/fieldcalc.png "Feldrechner-Dialog")
...
![Attributtabelle mit neuer Spalte](/giscurriculum/images/de/module6/media/area.png "Attributtabelle mit neuer Spalte")
...
![Ausgewählte Layer](/giscurriculum/images/de/module6/media/add-layers.png "Ausgewählte Layer")

Abbildung 6.7: Ausgewählte Layer

2. Wir wollen und die Schulen genauer anschauen. Öffnen Sie dafür die Attributtabelle für den Layer Schulen-Mittelsachsen. Klicken Sie auf die Schaltfläche "Objekte über Ausdruck wählen" ![](/giscurriculum/images/de/module6/media/select_features_button.png "Objekte über Ausdruck wählen Button") und geben Sie im Textbereich folgenden Ausdruck ein:
...
![Dialog "Mit Ausdruck wählen"](/giscurriculum/images/de/module6/media/select.png)
...
![Ausgewählte Schulen auf Karte](/giscurriculum/images/de/module6/media/selected-canvas.png "image_tooltip")

Abbildung 6.9: Ausgewählte Schulen werden hervorgehoben (gelb)


![Ausgewählte Schulen in Attributtabelle](/giscurriculum/images/de/module6/media/selected-attr.png "image_tooltip")
