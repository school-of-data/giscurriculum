...
<!-- ![Wahre Größe von](/images/de/module0/media/true-size-of.png "Wahre Größe von Ländern") -->

<img
  src="/giscurriculum/images/de/module0/media/true-size-of.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Wahre Größe von Ländern"
/>
...
<div style={{ width: "100%", maxWidth: "75vw", overflowX: "scroll" }}>
  <table>
    <tr>
      <td>
        <img
          src="/giscurriculum/images/de/module0/media/blue-marble.jpg"
          style={{ width: "80%" }}
        />
        Abbildung 0.1. Die Blaue Kugel (<a href="https://commons.wikimedia.org/wiki/Earth#//images/de/module0/media/File:The_Blue_Marble.jpg">
          https://commons.wikimedia.org/wiki/Earth#//images/de/module0/media/File:The_Blue_Marble.jpg
        </a>)
      </td>
      <td>
        <img
          src="/giscurriculum/images/de/module0/media/globe.jpg"
          style={{ width: "100%" }}
        />
        Figure 0.2. de l'Isle globe (1765) (<a href="https://commons.wikimedia.org/wiki/Globe#//images/de/module0/media/File:3quarter_globe.jpg">
          https://commons.wikimedia.org/wiki/Globe#//images/de/module0/media/File:3quarter_globe.jpg
        </a>)
      </td>
    </tr>
  </table>
...
<!-- ![Die Erde als Orange](/images/de/module0/media/dalandan.png "Die Erde als Orange") -->

<img
  src="/giscurriculum/images/de/module0/media/dalandan.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Die Erde als Orange"
/>
...
<!-- ![Winkeltreue Kartenprojektion](/images/de/module0/media/conformal.png "Winkeltreue Kartenprojektion") -->

<img
  src="/giscurriculum/images/de/module0/media/conformal.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Winkeltreue Kartenprojektion"
/>
...
<!-- ![Flächentreue Kartenprojektion](/images/de/module0/media/authalic.png "Flächentreue Kartenprojektion") -->

<img
  src="/giscurriculum/images/de/module0/media/authalic.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Flächentreue Kartenprojektion"
/>
...
<!-- ![Längentreue Kartenprojektion](/images/de/module0/media/equidistant.png "Längentreue Kartenprojektion") -->

<img
  src="/giscurriculum/images/de/module0/media/equidistant.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Längentreue Kartenprojektion"
/>
...
<!-- ![Azimutal-längentreue Kartenprojektion](/images/de/module0/media/az-equidistant.png "Azimutal-längentreue Kartenprojektion") -->

{" "}

<img
  src="/giscurriculum/images/de/module0/media/az-equidistant.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Azimutal-längentreue Kartenprojektion"
/>
...
<!--
![Zylinder als entwickelbare Fläche](/images/de/module0/media/cylinder.png "Cylinder as a developable surface") -->

<img
  src="/giscurriculum/images/de/module0/media/cylinder.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Cylinder as a developable surface"
/>
...
<!-- ![Kegel als entwickelbare Fläche](/images/de/module0/media/cone.png "Kegel als entwickelbare Fläche") -->

<img
  src="/giscurriculum/images/de/module0/media/cone.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Kegel als entwickelbare Fläche"
/>
...
<!-- ![Ebene als entwickelbare Fläche](/images/de/module0/media/plane.png "Ebene als entwickelbare Fläche") -->

<img
  src="/giscurriculum/images/de/module0/media/plane.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ebene als entwickelbare Fläche"
/>
...
<!--
![Aspekte einer Kartenprojektion](/images/de/module0/media/aspects.png "Aspekete einer Kartenprojektion") -->

<img
  src="/giscurriculum/images/de/module0/media/aspects.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Aspekete einer Kartenprojektion"
/>
...
1. Welche Art von Kartenprojektion eignet sich am besten für die folgenden Anwendungsfälle?
   ...
   1. eine Karte für allgemeine Zwecke, die ansprechend aussehen soll -- **_Kompromiss_**
   2. eine Karte, die eine Flächenanalyse zwischen verschiedenen Orten zeigt -- **_Flächentreu_**
   3. eine Karte, die einen Vergleich einer 10-km-Pufferzone von verschiedenen Standorten zeigt -- **_Längentreu_**
...
2. Welche Art von Koordinatenreferenzsystem (geografisch oder projiziert) ist für die folgenden Anwendungsfälle am besten geeignet?
   ...
   1. Darstellung der Lage von Punkten unter Verwendung von GPS -- **_Geografisches Koordinatenreferenzsystem_**
   2. Berechnung der Entfernung zwischen zwei Punkten -- **_Projiziertes Koordinatenreferenzsystem_**

3. Richtig oder falsch -- Es ist möglich, die folgenden Kartenmerkmale zusammen in einer Karte zu erhalten:
   1. Fläche und Form -- **_Falsch_**
   2. Entfernung und Richtung -- **_Richtig_**
...
<!-- ![Geodatenmodell](/images/de/module0/media/spatial-model.png "Geodatenmodellierung der Realität") -->

<img
  src="/giscurriculum/images/de/module0/media/spatial-model.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Geodatenmodellierung der Realität"
/>
...
<!-- ![Rasterdatenmodell](/images/de/module0/media/raster.png "Rasterdatenmodell") -->

<img
  src="/giscurriculum/images/de/module0/media/raster.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Rasterdatenmodell"
/>
...
<!-- ![Vektordatenmodell](/images/de/module0/media/vector.png "Vektordatenmodell") -->

<img
  src="/giscurriculum/images/de/module0/media/vector.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Vektordatenmodell"
/>
...
1. Richtig oder Falsch:
   1. GIS können nur mit raumbezogenen Daten verwendet werden -- **_Falsch_**
   2. Eine Karte ist immer die Ausgabe bei der Verwendung von GIS -- **_Falsch_**
   3. Das Erlernen von GIS ist schwierig und teuer -- **_Falsch_**
...
<!-- ![Free and Open Source Software for Geospatial (FOSS4G) applications stack](/images/de/module0/media/foss4g-stack.jpeg "Free and Open Source Software for Geospatial (FOSS4G) applications stack") -->

<img
  src="/giscurriculum/images/de/module0/media/foss4g-stack.jpeg"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Free and Open Source Software for Geospatial (FOSS4G) applications stack"
/>
Abbildung 0.14. Ein Beispiel für einen Open-Source-Geospatial- (oder FOSS4G-) Stack
(von Simon Nitz ([https://twitter.com/si_nitz?lang=en](https://twitter.com/si_nitz?lang=en)))
...
um _kostenlose_ sondern um _frei lizensierte_ Software handelt.
