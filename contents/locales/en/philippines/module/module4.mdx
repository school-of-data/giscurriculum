...
title: philippines
language: english
description: Module 4 - Layer Styling and Symbology
date: ""
author: Ketty, Ben Hur
prev: "/en/philippines/module/module3"
next: "/en/philippines/module/module5"
mods:
...
outlines:
 ...
 - Basic raster and vector symbology
 - Blending modes and draw effects
 - Data defined overrides and geometry generators
---
...
*   Internet connection
*   QGIS 3.16 or later
*   [Module 4 data](https://drive.google.com/drive/folders/1VF2fYgy6DxvVLnwMTK2v99RFMMOUbbHt?usp=sharing)
   *   Pampanga administrative boundary layer (inside module4/module4.gpkg)
   *   Pampanga clinics (inside module4/module4.gpkg)
   *   Pampanga High Resolution Settlement Layer (module4/HRSL_Pampanga_Population.tif)
...
*   QGIS Symbology - [https://docs.qgis.org/latest/en/docs/training_manual/basic_map/symbology.html](https://docs.qgis.org/latest/en/docs/training_manual/basic_map/symbology.html)
...
*   set its symbology, and labels. These options are the same available in The Vector Properties Dialog ([https://docs.qgis.org/latest/en/docs/user_manual/working_with_vector/vector_properties.html#vector-properties-dialog](https://docs.qgis.org/latest/en/docs/user_manual/working_with_vector/vector_properties.html#vector-properties-dialog)). 
...
![alt_text](/giscurriculum/images/en/philippines/module4/media/layer-styling.png "image_tooltip")
...
![alt_text](/giscurriculum/images/en/philippines/module4/media/style-vector.png "image_tooltip")

![alt_text](/giscurriculum/images/en/philippines/module4/media/style-raster.png "image_tooltip")
...
*   Paletted/Unique values ([https://docs.qgis.org/latest/en/docs/user_manual/working_with_raster/raster_properties.html#paletted]()) - for single band files that come with an indexed palette (e.g. a digital topographic map) or for general use of palettes for rendering raster layers.
...
*   Hillshade ([(https://docs.qgis.org/latest/en/docs/user_manual/working_with_raster/raster_properties.html#hillshade-renderer](https://docs.qgis.org/latest/en/docs/user_manual/working_with_raster/raster_properties.html#hillshade-renderer)) - Creates hillshade from a band.
...
2. Add the two vector layers into qgis; Click the Add vector layer button ![alt_text](/giscurriculum/images/en/philippines/module4/media/add-vector.png "image_tooltip") or use the browser panel. 
...
![Default render](/giscurriculum/images/en/philippines/module4/media/default-vector-render.png "Default render")
...
![No fill rendering for the polygon](/giscurriculum/images/en/philippines/module4/media/no-fill-render.png "No fill rendering for the polygon")
...
![Layer Properties dialogue](/giscurriculum/images/en/philippines/module4/media/vector-style.png "Layer Properties dialogue")

Figure 4.5: Layer Properties dialogue

10. The resulting map should look as below

![Final vector render](/giscurriculum/images/en/philippines/module4/media/final-vector-render.png "Final vector render")
...
![Symbology menu](/giscurriculum/images/en/philippines/module4/media/qgis9.png  "Symbology menu")
...
![Population density of Pampanga Province, Philippines](/giscurriculum/images/en/philippines/module4/media/hrsl-style.png "Population density of Pampanga Province, Philippines")

Figure 4.8: Population density of Pampanga Province, Philippines

5.  Zoom in to see the new map in finer detail.

![Zoomed-in map](/giscurriculum/images/en/philippines/module4/media/zoom-in.png "Zoomed-in map")
...
![The expected initial workspace](/giscurriculum/images/en/philippines/module4/media/initial-workspace.png "The expected initial workspace")
...
At the bottom of the Symbology menu, there’s a checkbox for Draw effects. Let’s enable that, and then click the customise effects button ![alt_text](/giscurriculum/images/en/philippines/module4/media/customise-effects-button.png "image_tooltip") to its right:

![Layer Properties window and Symbology menu](/giscurriculum/images/en/philippines/module4/media/draw-effects.png "Layer Properties window and Symbology menu")

Figure 4.11: Layer Properties window and Symbology menu

3. A new Effects Properties dialog opens

![Effects properties dialogue](/giscurriculum/images/en/philippines/module4/media/new-effects-dialog.png "Effects properties dialogue")
...
![Select effect type as blur](/giscurriculum/images/en/philippines/module4/media/blur-effect.png "Select effect type as blur")
...
![Blurry layer](/giscurriculum/images/en/philippines/module4/media/blurry-result.png "Blurry layer")
...
![Effects properties dialogue](/giscurriculum/images/en/philippines/module4/media/drop-shadow.png "Effects properties dialogue")
...
![Drop shadow effect](/giscurriculum/images/en/philippines/module4/media/drop-shadow-result.png "Drop shadow effect")
...
![Centroid operation on administrative boundary layer](/giscurriculum/images/en/philippines/module4/media/centroid.png "Centroid operation on administrative boundary layer")
...
![Point layer](/giscurriculum/images/en/philippines/module4/media/centroid-result.png "Point layer")

Figure 4.18: Point layer

4. Note that an alternative and easier way of writing spatial queries is using the ‘Expressions dialogue’. Click the ![alt_text](/giscurriculum/images/en/philippines/module4/media/expression.png "image_tooltip") expressions  button to open the 'Expression string builder' dialogue box. Here you’ll have access to an extensive function reference. You can search for a function by name. For example, type centroid in the search bar.
