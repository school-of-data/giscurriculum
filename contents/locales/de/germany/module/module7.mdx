...
![Fernerkundete Bilder verschiedener Küstenlinien](/giscurriculum/images/de/module7/media/rs-images.png "Fernerkundete Bilder verschiedener Küstenlinien")
...
![Hier wurden Gebäude auf einem Luftbild digitalisiert (nachgezeichnet)](/giscurriculum/images/de/module7/media/buildings.png "Hier wurden Gebäude auf einem Luftbild digitalisiert (nachgezeichnet)")
...
1. Um einen neuen GeoPackage Layer zu erstellen, wählen Sie die Schaltfläche Neuer Geopackage Layer ![](/giscurriculum/images/de/module7/media/geopackage-button.png)
...
![Dialog Neues GeoPaket Layer](/giscurriculum/images/de/module7/media/new-geopackage-dialog.png "Dialog Neues GeoPaket Layer")

Abbildung 7.3: Dialog Neues GeoPackage Layer

2. Der erste Schritt besteht darin, den Speicherort der Datenbankdatei anzugeben. Dazu drücken Sie den ![](/giscurriculum/images/de/module7/media/database-file-location.png) Button rechts neben dem Feld Database und wählen eine bestehende GeoPackage Datei aus oder erstellen eine neue. QGIS fügt automatisch die richtige Erweiterung an den von Ihnen angegebenen Namen an.
...
5. Geben Sie das Koordinatenreferenzsystem über die Schaltfläche ![](/giscurriculum/images/de/module7/media/mActionSetProjection.png) an
...
6. So fügen Sie dem Layer, den Sie erstellen, Felder hinzu:
    ...
    5. Klicken Sie auf die Schaltfläche Add to Fields List ![](/giscurriculum/images/de/module7/media/mActionNewAttribute.png)
...
1. Um einen neuen Layer im ESRI Shapefile-Format zu erstellen, drücken Sie die Schaltfläche ![](/giscurriculum/images/de/module7/media/mActionNewVectorLayer.png) "Neuer Shapedatei Layer..." im Menü "Layer ‣ Layer hinzufügen" oder in der Symbolleiste der Datenquellenverwaltung. Der Dialog Neuer Shapedatei Layer wird angezeigt, wie in Abbildung 7.4 dargestellt.

![](/giscurriculum/images/de/module7/media/new-shapefile-dialog.png)
...
6. Geben Sie das Koordinatenreferenzsystem über die Schaltfläche ![](/giscurriculum/images/de/module7/media/mActionSetProjection.png) an, Sie können das universelle WGS 84 wählen, das sich gut für WebMapping-Projekte auf der ganzen Welt eignet
...
7. So fügen Sie dem Layer, den Sie gerade erstellen, Felder hinzu:
    ...
    4. Klicken Sie auf die Schaltfläche Add to Fields List ![](/giscurriculum/images/de/module7/media/mActionNewAttribute.png)
...
2. Erstellen Sie ein neues Projekt in QGIS, indem Sie auf das Symbol _Neues Projekt_ ![alt_text](/giscurriculum/images/de/module7/media/new-project.png ) klicken.
3. Gehen Sie zu _Layer ‣ Layer erstellen ‣ Neuer Geopackage Layer_. Sie erhalten den folgenden Dialog:

![](/giscurriculum/images/de/module7/media/new-vector.png)
...
![ESRI World Imagery im Browser Bedienfeld](/giscurriculum/images/de/module7/media/xyz-2.png)

![ESRI World Imagery geladen in QGIS](/giscurriculum/images/de/module7/media/xyz-3.png)
...
![Details im ESRI World Imagery Layer](/giscurriculum/images/de/module7/media/digitize-zoom.png)
...
8. Klicken Sie auf die Schaltfläche _Bearbeitungsmodus umschalten_ ![](/giscurriculum/images/de/module7/media/edit-layer.png)
...
![Digitalisierwerkzeuge](/giscurriculum/images/de/module7/media/digi-toolbar.png "Digitalisierwerkzeuge")
...
1.  Klicken Sie auf die Schaltfläche _Polygonobjekt hinzufügen_ ![](/giscurriculum/images/de/module7/media/add-feature.png), um mit dem Digitalisieren zu beginnen. Wir werden die Gebäude digitalisieren
...
![ Neues Feature digitalisieren](/giscurriculum/images/de/module7/media/digitize-1.png)

Abbildung 7.8.1: Neues Feature digitalisieren

![Ausfüllen der Attributwerte](/giscurriculum/images/de/module7/media/digitize-2.png)
...
![Neues Objekt](/giscurriculum/images/de/module7/media/digitize-3.png "Neues Objekt")
...
![](/giscurriculum/images/de/module7/media/select-feature.png "image_tooltip")
...
<table>
  <tr>
   <td>
<img src="/giscurriculum/images/de/module7/media/image186.png" />
...
<img src="/giscurriculum/images/de/module7/media/image187.png" />
...
<img src="/giscurriculum/images/de/module7/media/image188.png" />
...
2. Klicken Sie auf die Schaltfläche Raster hinzufügen ![Raster hinzufügen](/giscurriculum/images/de/module7/media/add-raster.png "Add Raster"), um die Kartenbilddatei, [rk150cmyk_05500000_Münster.pdf](https://www.opengeodata.nrw.de/produkte/geobasis/vkg/rk150_f_pdf/rk150cmyk_05500000_Münster.pdf), als das zu georeferenzierende Bild hinzuzufügen. Die topographische Karte wird der Georeferenzierungs-Arbeitsfläche hinzugefügt. Sie können nun hineinzoomen, um die Details der Karte zu lesen. Eine Möglichkeit, dies zu tun, ist, die Metadaten und Legendeninformationen am rechten Rand zu lesen und sie dann mit den Merkmalen auf der Karte in Beziehung zu setzen.

![Karte im Georeferenzierung-Fenster](/giscurriculum/images/de/module7/media/georeferencer.png "Karte im Georeferenzierung-Fenster")
...
3. Öffnen Sie Einstellungen ► Transformationseinstellungen oder klicken Sie auf die Schaltfläche Transformationseinstellungen ![](/giscurriculum/images/de/module7/media/georef-settings-btn.png).
4. Klicken Sie auf das Symbol ![](/giscurriculum/images/de/module7/media/dots.png) um auszuwählen, wo die georefenzierte Karte gespeichert werden soll.
5. Stellen Sie den Rest der Parameter wie unten gezeigt ein

![Transformationsparameter](/giscurriculum/images/de/module7/media/transformation-settings.png "Transformationsparameter")
...
9. Klicken Sie auf die Schaltfläche Punkt hinzufügen ![](/giscurriculum/images/de/module7/media/add-point.png) und klicken Sie in den Schnittpunkt der Fadenkreuze (Schwenken und Zoomen nach Bedarf).
...
![GCP auswählen](/giscurriculum/images/de/module7/media/georef-1.png "GCP auswählen")

Abbildung 7.11.1: Kartenkoordinaten eingeben

![Kartenkoordinaten eingeben](/giscurriculum/images/de/module7/media/georef-2.png "Kartenkoordinaten eingeben")
...
![Erste Koordinate für die Georeferenzierung](/giscurriculum/images/de/module7/media/georef-3.png "Erste Koordinate für die Georeferenzierung")
...
15. Abschließend georeferenzieren Sie Ihre Karte mit **Datei ► Georeferenzierung starten** oder der Schaltfläche ![Georeferenzierung starten](/giscurriculum/images/de/module7/media/georef-start-btn.png "Start Georeferencing button").

![GCPs hinzugefügt](/giscurriculum/images/de/module7/media/georef-4.png "GCPs hinzugefügt")

Abbildung 7.13: GCPs hinzugefügt

![Georeferenzierte Karte in QGIS geladen](/giscurriculum/images/de/module7/media/georef-5.png "Georeferenzierte Karte in QGIS geladen")
