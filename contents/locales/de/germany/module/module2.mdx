...
![Mehrschichtige Analyse im GIS](/giscurriculum/images/de/module2/media/spatial-layers.jpg "Mehrschichtige Analyse im GIS")
...
![Das QGIS Browser Bedienfeld](/giscurriculum/images/de/module2/media/qgis-browser-1.png "Das QGIS Browser Bedienfeld")
...
5. Überprüfen Sie die Dateien im Ordner (Abbildung 2.3). Es gibt mehrere von ihnen. Aus dem Dateibaum selbst können wir bereits eine Vorstellung von den Dateien und Layern gewinnen, die wir in QGIS laden können. Die Icons links neben den Namen zeigen an, ob es sich um einen Vektor ![Vektorsymbol](/giscurriculum/images/de/module2/media/symbol-vector.png "Vector symbol")
   , ein Raster ![Raster-Symbol](/giscurriculum/images/de/module2/media/symbol-raster.png "Raster-Symbol"), eine Datenbank ![Datenbank-Symbol](/giscurriculum/images/de/module2/media/symbol-db.png "Datenbank-Symbol"), oder einfache tabellarische Daten ![Tabellen-Symbol](/giscurriculum/images/de/module2/media/symbol-table.png "Tabellen-Symbol").

![Modul-2-Dateien im Browser-Bedienfeld](/giscurriculum/images/de/module2/media/qgis-browser-2.png "Modul-2-Dateien im Browser-Bedienfeld")
...
![Layereigenschaften anzeigen](/giscurriculum/images/de/module2/media/qgis-browser-3.png "Layereigenschaften anzeigen")

Abbildung 2.4.Layereigenschaften anzeigen

![Layereigenschaften Fenster](/giscurriculum/images/de/module2/media/qgis-browser-layer-properties.png "Layereigenschaften Fenster")
...
<img
  src="/giscurriculum/images/de/module2/media/vector-layers-loaded-1.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Die in QGIS geladenen Vektorebenen"
/>
...
<img
  src="/giscurriculum/images/de/module2/media/layers-panel-1.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Das Layer-Bedienfeld"
/>
...
![Der Dialog "Layereigenschaften"](/giscurriculum/images/de/module2/media/layer-properties.png "Der Dialog "Layereigenschaften"")
...
![Informationseigenschaften des Layers Sachsen_Landesgrenze](/giscurriculum/images/de/module2/media/metadata-1.png "Informationseigenschaften des Layers Sachsen_Landesgrenze")
...
![Bearbeiten einiger Metadaten](/giscurriculum/images/de/module2/media/metadata-2.png "Editieren einiger Metadaten")
...
![Die Registerkarte Information nach dem Bearbeiten einiger Metadaten](/giscurriculum/images/de/module2/media/metadata-3.png "Die Registerkarte Information nach dem Bearbeiten einiger Metadaten")
...
1. Richtig oder Falsch:
   ...
   1. Alle Vektordateien sind Shapefiles. -- **_Falsch (ein Shapefile ist ein Dateiformat einer Vektordatei. Andere Vektordatendateiformate sind geopackage, geojson und flatgeobuf)_**
   2. Beim Rendern auf der Kartenansicht überdeckt ein Layer, der im Ebenenbedienfeld höher ist, immer einen Layer, der im Ebenenbedienfeld niedriger ist, oder erscheint darüber. -- **_Falsch (wenn aktiviert, überschreibt die Anordnung im Layerreihenfolge-Bedienfeld die Anordnung im Layer-Bedienfeld)_**
   3. Sie können Metadaten-Informationen zu einem Layer im Layer-Bedienfeld und im Browser-Bedienfeld überprüfen. -- **_Richtig_**
...
![Datenquellenverwaltung](/giscurriculum/images/de/module2/media/data-source-manager-1.png "Datenquellenverwaltung")
...
2. **Laden von Vektordaten**
   ...
   2. Lassen Sie uns die Vektordatei (McDonalds) laden, die sich im Geopaket Sachsen.gpkg befindet. Dieser Layer ist ein Punkt-Layer mit den Standorten der McDonalds Filialen in Sachsen.
      ...
      1. Quelltyp: Datei
      2. Quelle: Wählen Sie das Geopaket Sachsen über die Schaltfläche ![Suchbutton](/giscurriculum/images/de/module2/media/data-source-manager-search.png "Suchbutton")
      3. Klicken Sie auf Hinzufügen
      4. Wenn mehr als eine Vektordatei im Geopaket enthalten ist, fragt QGIS Sie, welche geladen werden soll.

![Laden von Vektordaten aus einem Geopackage](/giscurriculum/images/de/module2/media/data-source-manager-vector.png "Laden von Vektordaten aus einem Geopackage")
...
![Laden von Rasterdaten aus einem GeoPackage](/giscurriculum/images/de/module2/media/data-source-manager-raster.png "Laden von Rasterdaten aus einem GeoPackage")
...
4. **Laden von CSV- und anders separierten Textdateien**
   ...
   4. Im Datenordner befindet sich eine CSV-Datei mit dem Namen Sachsen_Burger-King.csv, die Punktstandorte von Burger-King-Filialen in Sachsen enthält. Um sie zu laden:
      ...
      2. Dateiname: Wählen Sie die Sachsen_Burger-King CSV über die Schaltfläche ![Suchbutton](/giscurriculum/images/de/module2/media/data-source-manager-search.png "Suchbutton")
      3. Dateiformat: CSV
...
<img
  src="/giscurriculum/images/de/module2/media/data-source-manager-csv.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Laden einer CSV-Datei"
/>
...
![Layer-Bedienfeld mit allen geladenen Layern](/giscurriculum/images/de/module2/media/layers-panel-2.png "Layer-Bedienfeld mit allen geladenen Layern")
...
<img
  src="/giscurriculum/images/de/module2/media/map-canvas-1.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="QGIS-Oberfläche mit allen geladenen Layern"
/>
...
![Hinzufügen einer XYZ-Verbindung in QGIS](/giscurriculum/images/de/module2/media/xyz-1.png "Hinzufügen einer XYZ-Verbindung in QGIS")
...
![Stamen Watercolor-Kachelserver dem Browser-Bedienfeld hinzugefügt](/giscurriculum/images/de/module2/media/xyz-2.png "Stamen Watercolor-Kachelserver dem Browser-Bedienfeld hinzugefügt")
...
<img
  src="/giscurriculum/images/de/module2/media/xyz-3.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="PGP Basemap Layer geladen in QGIS"
/>
...
![Adding ESRI World Imagery as XYZ Tiles](/giscurriculum/images/de/module2/media/xyz2-1.png "Adding ESRI World Imagery as XYZ Tiles")
...
![Erstellen einer neuen WMS/WMTS-Verbindung](/giscurriculum/images/de/module2/media/wms-1.png "Erstellen einer neuen WMS/WMTS-Verbindung")
...
![Die Ortophotos im Browser Bedienfeld](/giscurriculum/images/de/module2/media/wms-2.png "Die Ortophotos im Browser Bedienfeld")
...
<img
  src="/giscurriculum/images/de/module2/media/wms-3.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ortophotos aus WMS in QGIS geladen"
/>
...
1. Richtig oder Falsch:
   ...
   1. Sie können in QGIS nur lokale Dateien laden -- **_Falsch (Sie können auch entfernte Dateien laden, z.B. solche, die online gespeichert sind oder von Webservices bereitgestellt werden)_**
...
<img
  src="/giscurriculum/images/de/module2/media/exporting-layers.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Exportieren eines Layers aus QGIS"
/>
...
![Dialogfeld "Vektorlayer speichern"](/giscurriculum/images/de/module2/media/save-vector.png "Dialogfeld "Vektorlayer speichern"")
...
Natürlich können Sie den temporären Layer auch einfach dauerhaft machen, indem Sie den Layer in eine Datei exportieren. Ein Klick auf das Symbol ![Temporäres Layersymbol](/giscurriculum/images/de/module2/media/symbol-temp.png "Temporäres Layersymbol") öffnet automatisch einen Dialog zum Exportieren von Layern.
...
1. Richtig oder Falsch:
   ...
   1. Beim Exportieren eines Vektor-Layers können Sie das Format auswählen, in dem er gespeichert werden soll. -- **_Richtig_**
   2. Temporäre Layer werden von QGIS immer vergessen, wenn es geschlossen wird. -- **_Falsch (sie können mit Hilfe des Plugins Memory Layer Saver persistent gemacht werden)_**
   3. Wenn der Basis-Layer für einen virtuellen Layer aktualisiert wird, wird der virtuelle Layer automatisch auf der Kartenansicht aktualisiert, ohne dass eine Benutzereingabe erforderlich ist. -- **_Falsch (der/die Benutzer:in muss die Kartenansicht entweder durch Schwenken oder Zoomen aktualisieren, bevor die Aktualisierung der virtuellen Layer auf der Kartenansicht angezeigt wird)_**
...
![Mit GeoNode verbinden](/giscurriculum/images/de/module2/media/connect-geonode.png "Mit GeoNode verbinden")
...
![Neue Bäume hinzufügen](/giscurriculum/images/de/module2/media/virtual-3.png "Neue Bäume hinzufügen")

8. Vergessen Sie nach dem Hinzufügen der Punkte nicht, Ihre Bearbeitungen zu speichern, indem Sie auf ![Symbol für Bearbeitungen speichern](/giscurriculum/images/de/module2/media/symbol-save-edits.png "Symbol für Bearbeitungen speichern") in der Symbolleiste "Digitalisieren" klicken, bevor Sie die Bearbeitung ausschalten.

<img
  src="/giscurriculum/images/de/module2/media/virtual-4.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Neue Punkte (Bäume) hinzugefügt"
/>

9. Fügen Sie einen virtuellen Layer hinzu, indem Sie auf ![Virtuellen Layer hinzufügen](/giscurriculum/images/de/module2/media/symbol-virtual.png "Virtuellen Layer hinzufügen")
...
![Virtuellen Layer erstellen](/giscurriculum/images/de/module2/media/virtual-5.png "Virtuellen Layer erstellen")

<img
  src="/giscurriculum/images/de/module2/media/virtual-6.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Virtueller Layer in QGIS"
/>
