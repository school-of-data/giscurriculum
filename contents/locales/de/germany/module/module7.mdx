...
6. So fügen Sie dem Layer, den Sie erstellen, Felder hinzu:
   ...
   3. Geben Sie je nach ausgewähltem Datenformat die maximale Länge der Werte ein.
...
<img
  src="/giscurriculum/images/de/module7/media/xyz-3.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="ESRI World Imagery geladen in QGIS"
/>
...
<img
  src="/giscurriculum/images/de/module7/media/digitize-zoom.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Details im ESRI World Imagery Layer"
/>
...
<img
  src="/giscurriculum/images/de/module7/media/digitize-1.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Neues Feature digitalisieren"
/>
...
<img
  src="/giscurriculum/images/de/module7/media/digitize-3.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Neues Objekt"
/>
...
<img
  src="/giscurriculum/images/de/module7/media/select-feature.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="image_tooltip"
/>
...
<img
  src="/giscurriculum/images/de/module7/media/georeferencer.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Karte im Georeferenzierung-Fenster"
/>
...
<img
  src="/giscurriculum/images/de/module7/media/georef-1.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="GCP auswählen"
/>
...
<img
  src="/giscurriculum/images/de/module7/media/georef-3.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Erste Koordinate für die Georeferenzierung"
/>
...
15. Sie können die Passpunkte speichern **Datei ► GCP-Punkte speichern als...**.
16. Abschließend georeferenzieren Sie Ihre Karte mit **Datei ► Georeferenzierung starten** oder der Schaltfläche ![Georeferenzierung starten](/giscurriculum/images/de/module7/media/georef-start-btn.png "Start Georeferencing button").

<img
  src="/giscurriculum/images/de/module7/media/georef-4.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="GCPs hinzugefügt"
/>

Abbildung 7.13: GCPs hinzugefügt

<img
  src="/giscurriculum/images/de/module7/media/georef-5.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Georeferenzierte Karte in QGIS geladen"
/>
