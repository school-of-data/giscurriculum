...
![OpenStreetMap-Website](/giscurriculum/images/de/module3/media/osm.png "OpenStreetMap-Website")
...
![Mittelsachsen Layer in QGIS](/giscurriculum/images/de/module3/media/quickosm-1.png "Mittelsachsen Layer in QGIS")
...
![QuickOSM-Plugin](/giscurriculum/images/de/module3/media/quickosm-2.png "QuickOSM-Plugin")
...
![Alle Straßen im Layerausschnitt Frankenberg](/giscurriculum/images/de/module3/media/quickosm-3.png "Alle Straßen im Layerausschnitt Frankenberg")
...
![Geladene Straßendaten](/giscurriculum/images/de/module3/media/quickosm-4.png "Geladene Straßendaten")
...
![Die Overpass-Version der Schnellabfrage zum Laden von Straßen](/giscurriculum/images/de/module3/media/quickosm-5.png "Die Overpass-Version der Schnellabfrage zum Laden von Straßen")
...
![Als fast_food markierte Punkte in Mittelsachsen](/giscurriculum/images/de/module3/media/quickosm-6.png "Als fast_food markierte Punkte in Mittelsachsen")

Abbildung 3.7: Als fast_food markierte Punkte in Mittelsachsen

9. Die Ausgabe sollte in etwa wie folgt aussehen:

![Fast-Food Standorte aus OSM](/giscurriculum/images/de/module3/media/quickosm-7.png "Fast-Food Standorte aus OSM")
...
![HRSL-Daten zum HDX](/giscurriculum/images/de/module3/media/hdx.png "HRSL-Daten zum HDX")
...
![Der HRSL für Mittelsachsen](/giscurriculum/images/de/module3/media/hrsl-1.png "Der HRSL für Mittelsachsen")
...
![Schnellabfrage zum Laden aller als Fast Food gekennzeichneten Einrichtungen](/giscurriculum/images/de/module3/media/overpass-0.png "Schnellabfrage zum Laden aller als Fast Food gekennzeichneten Einrichtungen")

Schnellabfrage zum Laden aller als Fast Food gekennzeichneten Einrichtungen

2. Klicken Sie auf Abfrage anzeigen.

![Overapss-Version der Abfrage](/giscurriculum/images/de/module3/media/overpass-1.png "Overapss-Version der Abfrage")
...
![Overpass-Abfrage, um nur Fastfood-Filialen mit dem Namen McDonald's](/giscurriculum/images/de/module3/media/overpass-2.png "Overpass-Abfrage, um nur Fastfood-Filialen mit dem Namen McDonald's")
...
![McDonald's Filialen aus OSM](/giscurriculum/images/de/module3/media/overpass-3.png "McDonald's Filialen aus OSM")
