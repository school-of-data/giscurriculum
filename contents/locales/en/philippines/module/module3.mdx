...
title: philippines
language: english
description: Module 3 - Introduction to OpenStreetMap and the High Resolution Settlement Layer
date: ""
author: Ben Hur
prev: "/en/philippines/module/module2"
next: "/en/philippines/module/module4"
mods:
...
outlines:
 ...
 - The High Resolution Settlement Layer (HRSL) data
---
...
![OpenStreetMap website](/giscurriculum/images/en/philippines/module3/media/osm.png "OpenStreetMap website")
...
![Pampanga layers loaded in QGIS](/giscurriculum/images/en/philippines/module3/media/quickosm-1.png "Pampanga layers loaded in QGIS")
...
![QuickOSM plugin](/giscurriculum/images/en/philippines/module3/media/quickosm-2.png "QuickOSM plugin")
...
![Load all highways in the Pampanga_SanFernando layer extent](/giscurriculum/images/en/philippines/module3/media/quickosm-3.png "Load all highways in the Pampanga_SanFernando layer extent")
...
![Highway data loaded from OSM](/giscurriculum/images/en/philippines/module3/media/quickosm-4.png "Highway data loaded from OSM")
...
![The Overpass query version of the Quick query to load highways](/giscurriculum/images/en/philippines/module3/media/quickosm-5.png "The Overpass query version of the Quick query to load highways")
...
![Load amenities (points) tagged as fast_food in the Pampanga_province layer extent](/giscurriculum/images/en/philippines/module3/media/quickosm-6.png "Load amenities (points) tagged as fast_food in the Pampanga_province layer extent")
...
![Fast food locations loaded from OSM](/giscurriculum/images/en/philippines/module3/media/quickosm-7.png "Fast food locations loaded from OSM")
...
![HRSL data on HDX](/giscurriculum/images/en/philippines/module3/media/hdx.png "HRSL data on HDX")
...
![The HRSL for Pampanga, Philippines](/giscurriculum/images/en/philippines/module3/media/hrsl-1.png "The HRSL for Pampanga, Philippines")
...
![QuickOSM parameters for loading fast foods in Pampanga](/giscurriculum/images/en/philippines/module3/media/quickosm-6.png "QuickOSM parameters for loading fast foods in Pampanga")

Quick query to load all amenities tagged as fast food

2. Click Show query.

![Overpass version of the query](/giscurriculum/images/en/philippines/module3/media/overpass-1.png "Overpass version of the query")
...
![Overpass query to load only fast foods named Jollibee](/giscurriculum/images/en/philippines/module3/media/overpass-2.png "Overpass query to load only fast foods named Jollibee")
...
![Amenities tagged as fast food whose name is Jollibee loaded from OSM](/giscurriculum/images/en/philippines/module3/media/overpass-3.png "Amenities tagged as fast food whose name is Jollibee loaded from OSM")
