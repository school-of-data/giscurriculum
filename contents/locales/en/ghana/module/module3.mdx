...
1. True or False:
   ...
   1. A feature in OpenStreetMap can only have one tag or attribute. -- **_False_**
   2. You can only add points in OpenStreetMap. -- **_False (you can also other features such as lines and polygons)_**
   3. OpenStreetMap can only be used as an online map. -- **_False (you can also download and use the vector data created by OpenStreetMap such as when using them with the QuickOSM plugin)_**
