...
language: arabic
description: الوحدة 1 - مقدمة بسيطة لمفاهيم نظم المعلومات الجغرافية
date: ""
author:
prev: "/ar/united-arab-emirates/module/module1"
next: "/ar/united-arab-emirates/module/module3"
mods:
 - الوحدة 0 - مقدمة بسيطة لمفاهيم نظم المعلومات الجغرافية[/ar/united-arab-emirates/module/module0]
 - الوحدة 1 - مقدمة بسيطة لمفاهيم نظم المعلومات الجغرافية[/ar/united-arab-emirates/module/module1]
 - الوحدة 2 - الطّبقات في QGIS[/ar/united-arab-emirates/module/module2]
 - الوحدة 3 - خريطة الشارع المفتوحة وطبقة التسوية عالية الدقة[/ar/united-arab-emirates/module/module3]
 - الوحدة 4 - طبقات التصميم - Styling Layers[/ar/united-arab-emirates/module/module4]
 - الوحدة 5 - صنع الخرائط[/ar/united-arab-emirates/module/module5]
 - الوحدة 6 - سمات الطبقة[/ar/united-arab-emirates/module/module6]
 - الوحدة 7 - إنشاء الطبقات وتحريرها[/ar/united-arab-emirates/module/module7]
outlines:
---
...
*   دليل مستخدم QGIS 
    * [https://docs.qgis.org/latest/en/docs/user_manual](https://docs.qgis.org/latest/en/docs/user_manual)

*   دليل تدريب QGIS 
    * [https://docs.qgis.org/latest/en/docs/training_manual/index.html](https://docs.qgis.org/latest/en/docs/training_manual/index.html)
...
![Map of Bogota, Columbia in the style of Starry Starry Night](/images/ar/united-arab-emirates/module1/media/sample-1.jpg "Map of Bogota, Columbia in the style of Starry Starry Night")
...
![Storm trace data between 1851 to 2020](/images/ar/united-arab-emirates/module1/media/sample-2.jpg "Storm trace data between 1851 to 2020")
...
![Map of Kerguelen Island](/images/ar/united-arab-emirates/module1/media/sample-3.jpg "Map of Kerguelen Island")
...
![Field goal attempts and points scored in UAAP Season 81](/images/ar/united-arab-emirates/module1/media/sample-4.jpg "Field goal attempts and points scored in UAAP Season 81")
...
![QGIS Map Showcase](/images/ar/united-arab-emirates/module1/media/qgis-map-showcase.png "QGIS Map Showcase")
...
![The QGIS interface](/images/ar/united-arab-emirates/module1/media/qgis-interface.png "The QGIS interface")
...
![Parts of the QGIS Interface](/images/ar/united-arab-emirates/module1/media/qgis-interface-parts.png "Parts of the QGIS Interface")
...
![QGIS interface with some customizations](/images/ar/united-arab-emirates/module1/media/qgis-interface-custom.png "QGIS interface with some customizations")
...
![Open QGIS and click on View menu](/images/ar/united-arab-emirates/module1/media/ex01-01.png "Open QGIS and click on View menu")

3. لاحظ قائمة اللوحات (**Panels** menu)


![Observe the Panels menu](/images/ar/united-arab-emirates/module1/media/ex01-02.png "Observe the Panels menu")

4. لاحظ قائمة أشرطة الأدوات (**Toolbars** menu)


![Observe the Toolbars menu](/images/ar/united-arab-emirates/module1/media/ex01-03.png "Observe the Toolbars menu")
...
![Manage and Install Plugins dialog](/images/ar/united-arab-emirates/module1/media/manage-and-install-plugins-dialog.png "Manage and Install Plugins dialog")
...
![Open Manage and Install Plugins dialog](/images/ar/united-arab-emirates/module1/media/plugins-menu-2.png "Open Manage and Install Plugins dialog")
...
![Install Memory Layer Saver plugin](/images/ar/united-arab-emirates/module1/media/memory-layer-saver-plugin.png "Install Memory Layer Saver plugin")

    - QuickOSM 


![Install QuickOSM plugin](/images/ar/united-arab-emirates/module1/media/quickosm-plugin.png "Install QuickOSM plugin")
...
![The System Settings](/images/ar/united-arab-emirates/module1/media/settings-1.png "The System Settings")

Figure 7. إعدادات النظام


![Project Settings](/images/ar/united-arab-emirates/module1/media/settings-2.png "Project Settings")
...
![General Settings of QGIS](/images/ar/united-arab-emirates/module1/media/change-theme.png "General Settings of QGIS")
...
![Accessing User Profiles](/images/ar/united-arab-emirates/module1/media/user-profiles-1.png "Accessing User Profiles")
...
![alt_text](/images/ar/united-arab-emirates/module1/media/user-profiles-2.png "image_tooltip")

2. أدخل اسم المستخدم الجديد الخاص بك.


![alt_text](/images/ar/united-arab-emirates/module1/media/user-profiles-3.png "image_tooltip")
...
بالنسبة لملحقات Python الإضافية، من الجيد الاطلاع على PyQGIS Developer Cookbook ([https://docs.qgis.org/latest/en/docs/pyqgis_developer_cookbook/](https://docs.qgis.org/latest/en/docs/pyqgis_developer_cookbook/)).
