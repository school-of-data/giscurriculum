...
![Eine Matrix von Werten](/giscurriculum/images/de/module9/media/fig91.png "Eine Matrix von Werten")
...
![Auf der linken Seite werden die Werte Zentroiden zugewiesen. Auf der rechten Seite werden die Werte dem Bereich der Gitterzelle - dem Pixel - zugewiesen.](/giscurriculum/images/de/module9/media/fig92.png)
...
<img
  src="/giscurriculum/images/de/module9/media/fig94.png"
...
![Beispiel für ein Histogramm, bei dem x ein Raster Layer ist](/giscurriculum/images/de/module9/media/fig95.png "Beispiel für ein Histogramm, bei dem x ein Raster Layer ist")
...
<table>
  ...
  <tr>
    <td>0</td>
    <td>282828</td>
    <td>Unknown. No or not enough satellite data available.</td>
  </tr>
  <tr>
    <td>20</td>
    <td>FFBB22</td>
  ...
  <tr>
    ...
    <td>FFFF4C</td>
    <td>
      Herbaceous vegetation. Plants without persistent stem or shoots above
      ground and lacking definite firm structure. Tree and shrub cover is less
      than 10 %.
    </td>
  </tr>
  <tr>
    ...
    <td>F096FF</td>
    <td>
      Cultivated and managed vegetation / agriculture. Lands covered with
      temporary crops followed by harvest and a bare soil period (e.g., single
      and multiple cropping systems). Note that perennial woody crops will be
  ...
  <tr>
    ...
    <td>B4B4B4</td>
    <td>
      Bare / sparse vegetation. Lands with exposed soil, sand, or rocks and
      never has more than 10 % vegetated cover during any time of the year.
    </td>
  </tr>
  <tr>
    <td>70</td>
    <td>F0F0F0</td>
    <td>Snow and ice. Lands under snow or ice cover throughout the year.</td>
  </tr>
  <tr>
    <td>80</td>
    <td>0032C8</td>
  ...
  <tr>
    ...
    <td>9900</td>
    <td>
      Closed forest, evergreen broad leaf. Tree canopy >70 %, almost all
      broadleaf trees remain green year round. Canopy is never without green
      foliage.
    </td>
  </tr>
  <tr>
    ...
    <td>70663E</td>
    <td>
      Closed forest, deciduous needle leaf. Tree canopy >70 %, consists of
      seasonal needle leaf tree communities with an annual cycle of leaf-on and
      leaf-off periods.
    </td>
  </tr>
  <tr>
    ...
    <td>00CC00</td>
    <td>
      Closed forest, deciduous broad leaf. Tree canopy >70 %, consists of
      seasonal broadleaf tree communities with an annual cycle of leaf-on and
      leaf-off periods.
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td>116</td>
    <td>7800</td>
    <td>Closed forest, not matching any of the other definitions.</td>
  </tr>
  <tr>
    <td>121</td>
    <td>666000</td>
  ...
  <tr>
    ...
    <td>8DB400</td>
    <td>
      Open forest, evergreen broad leaf. Top layer- trees 15-70 % and second
      layer- mixed of shrubs and grassland, almost all broadleaf trees remain
  ...
  <tr>
    ...
    <td>
      ...
      layer- mixed of shrubs and grassland, consists of seasonal needle leaf
  ...
  <tr>
    ...
    <td>A0DC00</td>
    <td>
      Open forest, deciduous broad leaf. Top layer- trees 15-70 % and second
      layer- mixed of shrubs and grassland, consists of seasonal broadleaf tree
  ...
  <tr>
    <td>126</td>
    <td>648C00</td>
    <td>Open forest, not matching any of the other definitions.</td>
  </tr>
  <tr>
    <td>200</td>
    <td>80</td>
    <td>Oceans, seas. Can be either fresh or salt-water bodies.</td>
  </tr>
</table>
...
<img
  src="/giscurriculum/images/de/module9/media/fig96.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Geladene Rasterdatensätze"
/>
...
![Grundlegende Metadaten eines Raster-Layers](/giscurriculum/images/de/module9/media/fig97.png)
...
<img
  src="/giscurriculum/images/de/module9/media/fig98.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Reprojizierungs-Funktionalität in QGIS"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig99_a.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Transformieren (Reprojizieren) Fenster"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig99_b.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Reprojizierter HRSL"
/>
...
![Resampling-Methode Nächster Nachbar](/giscurriculum/images/de/module9/media/fig910.png)
...
![Resample-Methode - bilinear](/giscurriculum/images/de/module9/media/fig911.png)
...
**Stapelverarbeitung** ist die Fähigkeit, mit minimaler Benutzer:inenninteraktion wiederholende Prozesse auf Daten auszuführen. Die meisten QGIS-Funktionalitäten verfügen über diese Option und sie kann im Prozessfenster aktiviert werden, indem man auf die Schaltfläche **Als Batchprozess starten** ![](/giscurriculum/images/de/module9/media/batch-btn.png) klickt und zum Reiter "Stapelverarbeitung" wechselt (siehe Abbildung 9.12).

<img
  src="/giscurriculum/images/de/module9/media/fig912.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Stapelverarbeitung in einem QGIS-Fenster"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig913_a.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Stapelverarbeitung zum Repojizieren der Landbedeckungslayers"
/>

Abbildung 9.13a - Stapelverarbeitung zum Repojizieren der Landbedeckungslayers

![Autofülleinstellungen](/giscurriculum/images/de/module9/media/fig913_b.png)

Abbildung 9.13b - Autofülleinstellungen

<img
  src="/giscurriculum/images/de/module9/media/fig913_c.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Reprojizierte Landbedeckungsraster"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig914.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Finden des GDAL-Verschmelz-Werkzeugs in der Verarbeitungswerkzeugen"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig915_a.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Auswahl der zusammenzuführenden SRTM-Layer"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig915_b.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Parameter des Merge-Verarbeitungsalgorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig915_c.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Zusammengeführte DSM-Daten"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig915_d.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Transformieren-Parameter"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig916.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Stapelverarbeitung zum Extrahieren von Informationen in eine separate HTML-Datei für mehrere Raster-Layer"
/>
...
![Histogrammfenster](/giscurriculum/images/de/module9/media/fig917.png)
...
![Ausschnitt des Histograms für den SRTM-Layer](/giscurriculum/images/de/module9/media/fig918.png)
...
![Auswahl der Min- und Max-Werte für die Neuklassifizierung des Rasters](/giscurriculum/images/de/module9/media/fig919.png)
...
![Das Value-Tool Bedienfeld](/giscurriculum/images/de/module9/media/fig920.png)
...
<img
  src="/giscurriculum/images/de/module9/media/fig921.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Aktiviertes Value Tool - Hervorhebung im ersten Reiter - Tabelle"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig922.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Verwenden einer Vektormaske, um die Rasterdaten einer bestimmten Region zu extrahieren"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig923.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Stapelverarbeitung zum Ausschneiden aller benötigten Raster-Layer auf Basis des Vektorlayers"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig924.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Zugeschnittene Rasterlayer"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig925.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="SRTM Daten stylisiert als Einkanalpseudofarbe"
/>
...
![Der Rasterrechner](/giscurriculum/images/de/module9/media/fig926.png)
...
<img
  src="/giscurriculum/images/de/module9/media/fig927.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Einfügen einer Formel in den Raster Calculator"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig928.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Neuer Layer mit allen Pixeln unter 200 Metern, erstellt mit dem Raster Calculator"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig929.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Räumliche Verteilung aller Pixel mit dem Wert 1, d. h. mit einer Höhe von weniger als 200 Metern"
/>
...
```
<img
  src="/giscurriculum/images/de/module9/media/fig930.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Verwendung des Raster Calculators zur Ermittlung von Bevölkerungsverteilungsklassen auf der Basis von Höhenlagen bis 200 m"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig931.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="UsiVerwenden des Value Tools zur Überprüfung der Ergebnisse der Rasterberechnung"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig932.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Bevölkerungsverteilung unter 200m, in einem 30m Raster"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig933_a.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Raster-zu-Vektor-Konvertierung"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig933_b.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Parameter für die Umwandlung von Raster in Vektor"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig934.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Konvertierung eines Rasterdatensatzes in einen Vektordatensatz"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig935.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Zonenstatistik in den Verarbeitunsgwerkzeugen"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig936.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Einstellen der Parameter für die zonale Statistik"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig937.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Resultierender Vektorlayer der Zonenstatistik"
/>
...
![](/giscurriculum/images/de/module9/media/fig938.png)
...
![](/giscurriculum/images/de/module9/media/fig939.png)
...
<img
  src="/giscurriculum/images/de/module9/media/fig940.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig942.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig943.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig944.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig945.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig946_a.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig946_b.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
![Zugeschnitten_LandCover_2019_25833 (100m)](/giscurriculum/images/de/module9/media/fig948_a.png)

![LC2019_Nächster_Nachbar](/giscurriculum/images/de/module9/media/fig948_b.png)

![LC2019_Modus](/giscurriculum/images/de/module9/media/fig948_c.png)
...
<img
  src="/giscurriculum/images/de/module9/media/fig949.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig950_a.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig950_b.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig951.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig952.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig953_a.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig953_b.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig954.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig955.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig956.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig957.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig958.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig959.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig960.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig961.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
<img
  src="/giscurriculum/images/de/module9/media/fig962.png"
  style={{ width: "100%", maxWidth: "75vw" }}
  alt="Ergebnis der Ausführung des Vereinigungen-Algorithmus"
/>
...
[^1]: Eine primitive Operation ist eine grundlegende Berechnung, die von einem Algorithmus ausgeführt wird.
[^2]: Die zeitliche Auflösung dieser Daten ist abhängig vom Breitengrad.
[^3]: JAXA ist die Japan Aerospace Exploration Agency
[^4]: Für die Zwecke dieser Übung betrachten wir das DHM als digitales Höhenmodell. Weitere Details zu den Unterschieden finden Sie im Abschnitt Begriffsgliederung
[^5]: Die Geospatial Data Abstraction Library (GDAL) ist eine Computersoftware-Bibliothek zum Lesen und Schreiben von Raster- und Vektordatenformaten für Geodaten.
[^6]: Sentinel-2 ist eine Erdbeobachtungsmission des Copernicus-Programms, die systematisch optische Bilder mit hoher räumlicher Auflösung (10 m bis 60 m) über Land und Küstengewässern aufnimmt. Weitere Einzelheiten finden Sie [hier (englischsprachig)](https://sentinel.esa.int/web/sentinel/missions/sentinel-2).
