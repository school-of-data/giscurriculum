...
title: philippines
language: english
description: Module 1 - Introduction to QGIS (Philippines, English)
date: ""
author: Ben Hur
prev: "/en/philippines/module/module0"
next: "/en/philippines/module/module2"
mods:
...
outlines:
 ...
 - Introduction to QGIS and the QGIS Interface
 - QGIS Plugins
 - QGIS Settings
 - QGIS File Formats
---
...
<img src="/giscurriculum/images/en/philippines/module1/media/sample-1.jpg" style={{ width: "100%", maxwidth: "75vw" }} alt= "Map of Bogota, Columbia in the style of Starry Starry Night" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/sample-2.jpg" style={{ width: "100%", maxwidth: "75vw" }} alt= "Storm trace data between 1851 to 2020" />


This next one ([https://flic.kr/p/FA9TiR](https://flic.kr/p/FA9TiR)) is a map of Kerguelen Island by Heinrich Lingnau Schneider.

<img src="/giscurriculum/images/en/philippines/module1/media/sample-3.jpg" style={{ width: "100%", maxwidth: "75vw" }} alt= "Map of Kerguelen Island" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/sample-4.jpg" style={{ width: "100%", maxwidth: "75vw" }} alt= "Field goal attempts and points scored in UAAP Season 81" />
...
### Phase 1: Introduction to QGIS and the QGIS Interface
...
<img src="/giscurriculum/images/en/philippines/module1/media/qgis-map-showcase.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "QGIS Map Showcase" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/qgis-interface.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "The QGIS interface" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/qgis-interface-parts.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Parts of the QGIS Interface" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/qgis-interface-custom.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "QGIS interface with some customizations" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/ex01-01.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Open QGIS and click on View menu" />

3. Observe the **Panels** menu


<img src="/giscurriculum/images/en/philippines/module1/media/ex01-02.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Observe the Panels menu" />

4. Observe the **Toolbars** menu


<img src="/giscurriculum/images/en/philippines/module1/media/ex01-03.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Observe the Toolbars menu" />
...
3. Manually adding the source code in your QGIS profile’s plugins folder. This folder can usually be found at: 
    ...
    3. **Windows:** C:\\Users\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins

<img src="/giscurriculum/images/en/philippines/module1/media/plugins-menu.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Manage and Install Plugins menu" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/manage-and-install-plugins-dialog.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Manage and Install Plugins dialog" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/plugins-menu-2.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Open Manage and Install Plugins dialog" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/memory-layer-saver-plugin.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Install Memory Layer Saver plugin" />

   - QuickOSM

<img src="/giscurriculum/images/en/philippines/module1/media/quickosm-plugin.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Install QuickOSM plugin" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/settings-1.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "The System Settings" />

Figure 1.7. The System Settings


<img src="/giscurriculum/images/en/philippines/module1/media/settings-2.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Project Settings" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/change-theme.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "General Settings of QGIS" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/user-profiles-1.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "Accessing User Profiles" />
...
<img src="/giscurriculum/images/en/philippines/module1/media/user-profiles-2.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "image_tooltip" />

2. Give your new user profile a name.


<img src="/giscurriculum/images/en/philippines/module1/media/user-profiles-3.png" style={{ width: "100%", maxwidth: "75vw" }} alt= "image_tooltip" />
...
### Phase 4 (additional): QGIS File Formats
