...
1.  Both Field calculator and Select by Expression dialogue can be used to develop expressions -- **_True_**
2.  Expressions can be used to update a new field -- **_True_**
3.  Expressions can be used to apply a style -- **_True_**
