...
title: philippines
language: english
description: Module 2 - Layers in QGIS (Philippines, English)
date: ""
author: Ben Hur
prev: "/en/philippines/module/module1"
next: "/en/philippines/module/module3"
mods:
...
outlines:
 ...
 - Data Types, File Formats, the Browser Panel, and the Layers Panel
 - The Data Source Manager and Connecting to Remote Services
 - Exporting Layers, Layers in Memory (Temporary), and Virtual Layers
...
*   working computer
*   internet connection
*   At least QGIS 3.16 installed in the computer ([https://qgis.org/en/site/forusers/download.html](https://qgis.org/en/site/forusers/download.html))
...
* QGIS User Guide - [https://docs.qgis.org/LATEST/en/docs/user_manual/](https://docs.qgis.org/LATEST/en/docs/user_manual/)
* QGIS Training Manual - [https://docs.qgis.org/LATEST/en/docs/training_manual/index.html](https://docs.qgis.org/LATEST/en/docs/training_manual/index.html)
...
![Multiple layer analysis in GIS](/giscurriculum/images/en/philippines/module2/media/spatial-layers.jpg "Multiple layer analysis in GIS")
...
### Phase 1: Data Types, File Formats, the Browser Panel, and the Layers Panel
...
To learn more about the Browser Panel, go to: [https://docs.qgis.org/LATEST/en/docs/user_manual/introduction/browser.html](https://docs.qgis.org/LATEST/en/docs/user_manual/introduction/browser.html)
...
![The QGIS Browser Panel](/giscurriculum/images/en/philippines/module2/media/qgis-browser-1.png "The QGIS Browser Panel")
...
5. Check the files inside the folder (Figure 2.3). There are several of them. From the file tree itself, we can already get an idea of the files and layers that we can load in QGIS. The icons on the left of the names indicate whether the data is a vector ![Vector symbol](/giscurriculum/images/en/philippines/module2/media/symbol-vector.png "Vector symbol"), a raster ![Raster symbol](/giscurriculum/images/en/philippines/module2/media/symbol-raster.png "Raster symbol"), a database ![Database symbol](/giscurriculum/images/en/philippines/module2/media/symbol-db.png "Database symbol"), or simple tabular data ![Table symbol](/giscurriculum/images/en/philippines/module2/media/symbol-table.png "Table symbol"). 


![Module 2 files in the Browser Panel](/giscurriculum/images/en/philippines/module2/media/qgis-browser-2.png "Module 2 files in the Browser Panel")
...
![Checking Layer Properties](/giscurriculum/images/en/philippines/module2/media/qgis-browser-3.png "Checking Layer Properties")

Figure 2.4.Checking Layer Properties

![Layer Properties from Browser Panel](/giscurriculum/images/en/philippines/module2/media/qgis-browser-layer-properties.png "Layer Properties from Browser Panel")
...
![The vector layers loaded in QGIS](/giscurriculum/images/en/philippines/module2/media/vector-layers-loaded-1.png "The vector layers loaded in QGIS")
...
![The Layers Panel](/giscurriculum/images/en/philippines/module2/media/layers-panel-1.png "The Layers Panel")
...
To learn more about the Layers Panel, go to: [https://docs.qgis.org/LATEST/en/docs/user_manual/introduction/general_tools.html#layers-panel](https://docs.qgis.org/LATEST/en/docs/user_manual/introduction/general_tools.html#layers-panel)
...
![The Layer Properties dialog](/giscurriculum/images/en/philippines/module2/media/layer-properties.png "The Layer Properties dialog")
...
To learn more about vector layer properties, go to: [https://docs.qgis.org/LATEST/en/docs/user_manual/working_with_vector/vector_properties.html](https://docs.qgis.org/LATEST/en/docs/user_manual/working_with_vector/vector_properties.html)

To learn more about raster layer properties, go to: [https://docs.qgis.org/LATEST/en/docs/user_manual/working_with_raster/raster_properties.html](https://docs.qgis.org/LATEST/en/docs/user_manual/working_with_raster/raster_properties.html)
...
![Information properties of the NCR_admin_boundary layer](/giscurriculum/images/en/philippines/module2/media/metadata-1.png "Information properties of the NCR_admin_boundary layer")
...
![Editing some metadata](/giscurriculum/images/en/philippines/module2/media/metadata-2.png "Editing some metadata")

Figure 2.10. Editing some metadata

4. Go to the Information tab again and see if anything changed.

![The Information tab after editing some metadata](/giscurriculum/images/en/philippines/module2/media/metadata-3.png "The Information tab after editing some metadata")
...
### Phase 2: The Data Source Manager and Connecting to Remote Services
...
![Data Source Manager](/giscurriculum/images/en/philippines/module2/media/data-source-manager-1.png "Data Source Manager")
...
2. **Loading Vectors**
    ...
    2. Let’s load the vector file (NCR_Jollibee) found inside the Philippines_NCR geopackage. This layer is a point layer of the locations of fast food restaurant Jollibee in NCR.
        ...
        1. Source Type: File
        2. Source: Select the Philippines_NCR geopackage using the ![Search button](/giscurriculum/images/en/philippines/module2/media/data-source-manager-search.png "Search button") button
        3. Click Add
        4. If there are more than 1 vector file inside the geopackage, QGIS will ask you to select which ones to load.

![Loading a vector inside a GeoPackage](/giscurriculum/images/en/philippines/module2/media/data-source-manager-vector.png "Loading a vector inside a GeoPackage")
...
![Loading a raster inside a GeoPackage](/giscurriculum/images/en/philippines/module2/media/data-source-manager-raster.png "Loading a raster inside a GeoPackage")
...
4. **Loading CSV and other Delimited Text Files**  
    ...
    4. There is a CSV file in the data folder named NCR_McDonalds.csv which contains point locations of McDonald’s branches in NCR. To load it:
        ...
        2. File name: Select the NCR_McDonalds CSV using the ![Search button](/giscurriculum/images/en/philippines/module2/media/data-source-manager-search.png "Search button") button
        3. File Format: CSV
...
![Loading a CSV file](/giscurriculum/images/en/philippines/module2/media/data-source-manager-csv.png "Loading a CSV file")
...
![Layers Panel with all layers loaded](/giscurriculum/images/en/philippines/module2/media/layers-panel-2.png "Layers Panel with all layers loaded")
...
![QGIS Interface with all layers loaded](/giscurriculum/images/en/philippines/module2/media/map-canvas-1.png "QGIS Interface with all layers loaded")
...
![Adding an XYZ connection in QGIS](/giscurriculum/images/en/philippines/module2/media/xyz-1.png "Adding an XYZ connection in QGIS")

Figure 2.18. Adding an XYZ connection in QGIS

5. This should add a PGP Basemap item under XYZ Tiles in the Browser Panel.

![PGP Basemap Tile server added to the Browser Panel](/giscurriculum/images/en/philippines/module2/media/xyz-2.png "PGP Basemap Tile server added to the Browser Panel")
...
![PGP Basemap layer loaded in QGIS](/giscurriculum/images/en/philippines/module2/media/xyz-3.png "PGP Basemap layer loaded in QGIS")
...
![Adding ESRI World Imagery as XYZ Tiles](/giscurriculum/images/en/philippines/module2/media/xyz2-1.png "Adding ESRI World Imagery as XYZ Tiles")
...
![Creating a new WMS/WMTS Connection](/giscurriculum/images/en/philippines/module2/media/wms-1.png "Creating a new WMS/WMTS Connection")
...
![The LiPAD 100-year Flood Hazard WMS added in the Browser Panel](/giscurriculum/images/en/philippines/module2/media/wms-2.png "The LiPAD 100-year Flood Hazard WMS added in the Browser Panel")
...
![Flood hazard map from WMS loaded in QGIS](/giscurriculum/images/en/philippines/module2/media/wms-3.png "Flood hazard map from WMS loaded in QGIS")
...
### Phase 3: Exporting Layers, Layers in Memory (Temporary), and Virtual Layers
...
![Exporting a layer from QGIS](/giscurriculum/images/en/philippines/module2/media/exporting-layers.png "Exporting a layer from QGIS")
...
![Save Vector Layer dialog](/giscurriculum/images/en/philippines/module2/media/save-vector.png "Save Vector Layer dialog")
...
Of course you can also just make the temporary layer permanent by exporting the layer to a file. Clicking the ![Temporary layer symbol](/giscurriculum/images/en/philippines/module2/media/symbol-temp.png "Temporary layer symbol") icon will automatically open an export layer dialog.
...
![Connect to GeoNode](/giscurriculum/images/en/philippines/module2/media/connect-geonode.png "Connect to GeoNode")
...
3. Create a new geopackage layer with ![Create new geopakage symbol](/giscurriculum/images/en/philippines/module2/media/symbol-gpkg.png "Create new geopakage symbol") in the Data Source Manager toolbar. Name it Trees, add a radius (integer) and species (text) fields, and use a projected CRS (e.g. EPSG:3857)

![New GeoPackage Layer](/giscurriculum/images/en/philippines/module2/media/virtual-1.png "New GeoPackage Layer")

When you are prompted that the file already exists, select Add New Layer.

![GeoPackage Layer exists](/giscurriculum/images/en/philippines/module2/media/virtual-2.png "GeoPackage Layer exists")


4. Toggle editing on Trees by right-clicking on it ‣ Toggle editing or clicking ![Toggle editing symbol](/giscurriculum/images/en/philippines/module2/media/symbol-edit.png "Toggle editing symbol") in the Digitizing Toolbar.
5. Select an area on the satellite image that has trees.
6. With Editing toggled on, enable adding points to the Trees layer by clicking ![Add new point symbol](/giscurriculum/images/en/philippines/module2/media/symbol-add-point.png "[Add new point symbol") (CTRL + .).
...
![Add new trees](/giscurriculum/images/en/philippines/module2/media/virtual-3.png "Add new trees")

8. After adding the points, don’t forget to save your edits by clicking ![Save edits symbol](/giscurriculum/images/en/philippines/module2/media/symbol-save-edits.png "Save edits symbol") in the Digitizing toolbar before toggling the Editing off.

![New points (trees) added](/giscurriculum/images/en/philippines/module2/media/virtual-4.png "New points (trees) added]")

9. Add a virtual layer by clicking ![Add virtual layer symbol](/giscurriculum/images/en/philippines/module2/media/symbol-virtual.png "Add virtual layer symbol") in the Data Source Manager toolbar.
...
![Create Virtual Layer](/giscurriculum/images/en/philippines/module2/media/virtual-5.png "Create Virtual Layer")

![Virtual layer in QGIS](/giscurriculum/images/en/philippines/module2/media/virtual-6.png "Virtual layer in QGIS")
