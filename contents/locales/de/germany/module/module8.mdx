...
![Von Punkt A nach B mit Openstreetmap](/giscurriculum/images/de/module8/media/osm-routing.png "Von Punkt A nach B mit Openstreetmap")
...
![Vektorlinien, die Straßen und die zugehörige Attributtabelle darstellen](/giscurriculum/images/de/module8/media/fig82.png "Vektorlinien, die Straßen und die zugehörige Attributtabelle darstellen")
...
![Vektordaten mit Attributtabelle](/giscurriculum/images/de/module8/media/fig83.png "Vektordaten mit Attributtabelle")
...
![Geladene Vektordatensätze: Punkte, Linien und Polygone](/giscurriculum/images/de/module8/media/starting-workspace.png "Geladene Vektordatensätze: Punkte, Linien und Polygone")
...
![Angaben zum im QGIS-Projekt verwendeten Koordinatenreferenzsystem](/giscurriculum/images/de/module8/media/crs-dialog.png "Angaben zum im QGIS-Projekt verwendeten Koordinatenreferenzsystem")
...
![Grundstatistik für Felder](/giscurriculum/images/de/module8/media/fig87.png)
...
![](/giscurriculum/images/de/module8/media/fig88.png "Preparing to run basics statistics for roads layer") [Vorbereiten der Grundlagenstatistik für den Layer Straßen)
...
![Topologie-Prüfung-Plugin](/giscurriculum/images/de/module8/media/fig89_a.png "Topologie-Prüfung-Plugin")
...
![Topologie-Prüfungsfenster](/giscurriculum/images/de/module8/media/fig89_c.png "Topologie-Prüfungsfenster")

Abbildung 8.9.c - Topologie-Prüfungsfenster


Um die Topologieregeln zu definieren, klicken Sie auf das dritte Symbol ![](/giscurriculum/images/de/module8/media/fig810_btn.png), wodurch sich ein Fenster wie in Abbildung 8.10 öffnet. 


![Topologieregeleinstellungen](/giscurriculum/images/de/module8/media/fig810.png)
...
![Dropdown-Menü für Topologieregeln auf Basis des ausgewählten Layers](/giscurriculum/images/de/module8/media/fig811.png "Dropdown-Menü für Topologieregeln auf Basis des ausgewählten Layers")
...
![Zu setzende Topologieregeln](/giscurriculum/images/de/module8/media/fig812.png "Zu setzende Topologieregeln")

Abbildung 8.12 - Einzustellende Topologieregeln 

Klicken Sie auf das erste Symbol ![Alle prüfen Button](/giscurriculum/images/de/module8/media/fig813_btn.png "Alle prüfen Button") im Fenster des Topologieprüfers, um die Prüfung auszuführen, und warten Sie auf die Ergebnisse. Nach dem Ausführen der Topologieprüfung sollte Ihr Kartenfenster wie in Abbildung 8.13 aussehen. 


![Topologieprüfungsergebnisse](/giscurriculum/images/de/module8/media/fig813.png "Topologieprüfungsergebnisse")
...
![Doppelter Punk im Points Of Interests Layer](/giscurriculum/images/de/module8/media/fig814.png "Doppelter Punk im Points Of Interests Layer")
...
![ Doppelte Geometrien im Layer Points of Interest löschen](/giscurriculum/images/de/module8/media/fig815.png)
...
![Nach dem Löschen der Duplikate](/giscurriculum/images/de/module8/media/fig816.png)
...
![Topologieprüfung auf dem Gebäude-Vektor-Layer](/giscurriculum/images/de/module8/media/fig817_a.png)
...
![Ergebnisse der Topologieprüfung auf dem Gebäude-Vektor-Layer](/giscurriculum/images/de/module8/media/fig817_b.png)
...
![Entfernen von doppelten Geometrien auf dem Gebäude-Vektor-Layer](/giscurriculum/images/de/module8/media/fig818_a.png)

Abbildung 8.18a - Entfernen von doppelten Geometrien auf dem Gebäude-Vektor-Layer


![Ausgabe nach dem Entfernen doppelter Geometrien auf dem Gebäude-Vektorlayer](/giscurriculum/images/de/module8/media/fig818_b.png)

![Ergebnisse des Entfernens doppelter Geometrien auf dem Gebäude-Vektorlayer](/giscurriculum/images/de/module8/media/fig818_c.png)
...
![Eindeutige Werte in einem Vektor Layer auflisten Funktionalität](/giscurriculum/images/de/module8/media/fig819_a.png "Eindeutige Werte in einem Vektor Layer auflisten Funktionalität")
...
![Eindeutige Werte in einer Vektor-Layer-Funktionalität auflisten (Batch-Verarbeitung)](/giscurriculum/images/de/module8/media/fig819_b.png)
...
![GroupStats plugin](/giscurriculum/images/de/module8/media/fig820_a.png "GroupStats plugin")
...
![GroupStats-Fenster](/giscurriculum/images/de/module8/media/fig820_b.png "GroupStats-Fenster")
...
![GroupStats auf dem Gebäudelayer](/giscurriculum/images/de/module8/media/fig821.png)
...
![GroupStats auf dem Straßenlayer](/giscurriculum/images/de/module8/media/fig822.png)
...
1. Sind Metadaten wichtig? 
  - <span style={{texDecoration:"underline"}}>Ja, denn sie geben einen Einblick in die geografischen Daten, den man sonst nicht erhalten könnte. </span>
...
3. Was ist wichtiger, die Geometrie oder die Attributdaten? 
  - Geometrie
  - Attributdaten
  - <span style={{texDecoration:"underline"}}>Beides.</span>
...
![Einstellen der Parameter für einen 500 m Puffer um Gotteshäuser](/giscurriculum/images/de/module8/media/fig823.png)
...
![Ergebnis der Pufferberechnung](/giscurriculum/images/de/module8/media/fig824.png)
...
![Fläche für den neu erhaltenen Layer, mit GroupStats berechnet](/giscurriculum/images/de/module8/media/fig825.png)
...
![Auswahl der Flächennutzung fclass = industrial](/giscurriculum/images/de/module8/media/fig826_a.png)

Abbildung 8.26a - Auswahl der Flächennutzung fclass = industrial. 

![Ausgewählte Industrieflächen](/giscurriculum/images/de/module8/media/fig826_b.png)
...
![Ausführen des Zuschneiden-Algorithmus](/giscurriculum/images/de/module8/media/fig827_a.png)
...
![Ergebnis der Zuschneiden-Funktionalität](/giscurriculum/images/de/module8/media/fig827_b.png)
...
![Filtern des POI-Layer nach Schulen](/giscurriculum/images/de/module8/media/fig828_a.png)

Abbildung 8.28a - Filtern des POI-Layer nach Schulen


![Schulen im POI-Layer](/giscurriculum/images/de/module8/media/fig828_b.png)

Abbildung 8.28b - Schulen im POI-Layer


![Ausführen des Voronoi-Algorithmus](/giscurriculum/images/de/module8/media/fig828_c.png)

Abbildung 8.28c - Ausführen des Voronoi-Algorithmus


![Ergebnis des Voronoi-Algorithmus](/giscurriculum/images/de/module8/media/fig828_d.png)
...
![Erstellen eines 10X10km-Vektorgitters](/giscurriculum/images/de/module8/media/fig829_a.png "Erstellen eines 10X10km-Vektorgitters")
...
![10X10km Vektorgitter](/giscurriculum/images/de/module8/media/fig829_b.png "10X10km Vektorgitter")
...
![Räumliche Verteilung der Grünflächen und bebauten Flächen](/giscurriculum/images/de/module8/media/fig830_b.png)
...
![Parameter für den Vereinugngen-Algorithmus](/giscurriculum/images/de/module8/media/fig831.png)

Abbildung 8.31 -  Parameter für den Vereinugngen-Algorithmus

Das Ergebnis sollte wie in Abbildung 8.32 aussehen.

![Ergebnis der Ausführung des Vereinigungen-Algorithmus](/giscurriculum/images/de/module8/media/fig832.png")
...
![Landnutzungsmerkmale, die für jede Rasterzelle ausgeschnitten wurden, und die zugehörige Attributtabelle. ](/giscurriculum/images/de/module8/media/fig833.png)
...
![Auswahl der Grünflächen](/giscurriculum/images/de/module8/media/fig834_a.png "Auswahl der Grünflächen")

Abbildung 8.34a - Auswählen der Grünflächen.


![Ausgewählte Grünflächen](/giscurriculum/images/de/module8/media/fig834_b.png "Ausgewählte Grünflächen")

Abbildung 8.34b - Ausgewählte Grünflächen.


![Grün- und bebaute Flächen](/giscurriculum/images/de/module8/media/fig834_c.png "Grün- und bebaute Flächen")
...
![Berechnung der Fläche jedes Objekts](/giscurriculum/images/de/module8/media/fig834_d.png)

Abbildung 8.34d - Berechnung der Fläche jedes Objekts.

![GroupStat-Parameter zum Aufsummieren der Grünflächen pro jede 10X10km-Zelle](/giscurriculum/images/de/module8/media/fig834_e.png)
...
![Laden von grünflächen-gitter.csv](/giscurriculum/images/de/module8/media/fig835_a.png)

Abbildung 8.35a - Laden von grünflächen-gitter.csv

![Die grünflächen-gitter CSV Attributtabelle](/giscurriculum/images/de/module8/media/fig835_b.png)
...
Klicken Sie im Fenster **Verknüpfungen** auf die grüne Plus-Schaltfläche ![](/giscurriculum/images/de/module8/media/add_join_btn.png) und stellen Sie die Parameter wie in Abbildung 8.35, für Grünflächen, ein.


![Einstellungen um über eine Verkünpfung der Felder grid_id und id die Grünflächngröße zu den Gitterzellen hinzuzufügen](/giscurriculum/images/de/module8/media/fig835_c.png)
...
![Verknüpfungseinstellungen ](/giscurriculum/images/de/module8/media/fig836_a.png)

Abbildung 8.36a - Verknüpfungseinstellungen

![Flächen in der Gitter-Attributtabelle](/giscurriculum/images/de/module8/media/fig836_b.png")
...
![Prozentsatz der grünen Fläche im 10km x 10km-Raster](/giscurriculum/images/de/module8/media/fig837_a.png "Prozentsatz der grünen Fläche im 10km x 10km-Raster")

Abbildung 8.37a - Prozentualer Anteil der Grünfläche im 10km x 10km-Raster


![Berechnung für das Verhältnis von Grün- und bebauter Fläche](/giscurriculum/images/de/module8/media/fig837_c.png "Berechnung für das Verhältnis von Grün- und bebauter Fläche")

Abbildung 8.37c - Berechnung für das Verhältnis von Grün- und bebauter Fläche


![Berechnetes Verhältnis von Grün- und bebauter Fläche](/giscurriculum/images/de/module8/media/fig837_d.png "Berechnetes Verhältnis von Grün- und bebauter Fläche")

Abbildung 8.37d - Berechnetes Verhältnis von Grün- und bebauter Fläche


![Verhältnis von Grün- und bebauten Flächen im 10km x 10km Raster](/giscurriculum/images/de/module8/media/fig837_e.png "Verhältnis von Grün- und bebauten Flächen im 10km x 10km Raster")
...
![Parameter für "Linienlängen summieren"](/giscurriculum/images/de/module8/media/fig838_a.png)

Abbildung 8.38a - Parameter für "Linienlängen summieren"


![Straßenlänge- und anzahl pro Gitterzelle](/giscurriculum/images/de/module8/media/fig838_b.png)

Abbildung 8.38b - Straßenlänge- und anzahl pro Gitterzelle


![Räumliche Verteilung der Straßenkilometer](/giscurriculum/images/de/module8/media/fig838_c.png)
...
![](/giscurriculum/images/de/module8/media/fig840_a.png "Auswählen von öffentlichen POIs")

Abbildung 8.40a - Auswählen von öffentlichen POIs


![Ausgewählte öffentliche POIS](/giscurriculum/images/de/module8/media/fig840_b.png "Ausgewählte öffentliche POIS")
...
![Anzahl öffentlicher POIS in jeder 10km x 10km Zelle](/giscurriculum/images/de/module8/media/fig840_c.png)

Abbildung 8.40c - Anzahl öffentlicher POIS in jeder 10kmx10km Zelle


![Räumliche Verteilung öffentlicher POIs pro 10X10km Zelle](/giscurriculum/images/de/module8/media/fig840_d.png)
...
![In QGIS verfügbare Interpolationsmethoden](/giscurriculum/images/de/module8/media/fig841.png "In QGIS verfügbare Interpolationsmethoden")
...
![Erzeugen von Zufallspunkten innerhalb eines Polygon-Layers](/giscurriculum/images/de/module8/media/fig842.png)
...
![Punktdaten-Layer - zufällig innerhalb der angegebenen Polygone erzeugt](/giscurriculum/images/de/module8/media/fig843.png)
...
![Zufallswerte innerhalb vorgegebener Grenzen erzeugen](/giscurriculum/images/de/module8/media/fig844.png "Zufallswerte innerhalb vorgegebener Grenzen erzeugen")
...
![Fiktive Nierderschlagsmengen in der Attributtabelle](/giscurriculum/images/de/module8/media/fig845.png)
...
![Einstellungen im Stapelverarbeitungsfensters zur Interpolation der Niederschlagswerte für alle 7 Tage](/giscurriculum/images/de/module8/media/fig846.png)
...
![Interpolierte Datensätze](/giscurriculum/images/de/module8/media/fig847.png)
...
![Zeitliche Informationen zum Rasterdatensatz setzen (1)](/giscurriculum/images/de/module8/media/fig848.png )
...
![Einstellen der Parameter des Zeitsteuerungsfeldes](/giscurriculum/images/de/module8/media/fig849.png)

Abbildung 8.49 - Einstellen der Parameter des Zeitsteuerungsfeldes. 

Klicken Sie auf den Play-Button ![Play-Button](/giscurriculum/images/de/module8/media/play-btn.png "Play-Button") und schauen Sie sich an, wie sich die Werte ändern. Sie können auswählen, welche anderen Layer sichtbar sein sollen. In Abbildung 8.50 haben wir den Gebäude-Vektor-Layer hinzugefügt. 

![Auswählen anderer Layer, die in der zeitlichen Animation sichtbar sein sollen](/giscurriculum/images/de/module8/media/fig850.png)
