...
![Bedienfeld Layergestaltung](/giscurriculum/images/de/module4/media/layer-styling.png "Bedienfeld Layergestaltung")
...
![alt_text](/giscurriculum/images/de/module4/media/style-vector.png "image_tooltip")

![alt_text](/giscurriculum/images/de/module4/media/style-raster.png "image_tooltip")
...
![Standard-Darstellung](/giscurriculum/images/de/module4/media/default-vector-render.png "Standard-Darstellung")
...
![Transparente Füllung für das Polygon](/giscurriculum/images/de/module4/media/no-fill-render.png "Transparente Füllung für das Polygon")
...
![Der Layereigenschaften Dialog für den Schullayer](/giscurriculum/images/de/module4/media/vector-style.png "Der Layereigenschaften Dialog für den Schullayer")

Abbildung 4.5: Der Layereigenschaften Dialog für den Schullayer

10. Die resultierende Karte sollte wie folgt aussehen

![Kartendarstellung der Schulen](/giscurriculum/images/de/module4/media/final-vector-render.png "Kartendarstellung der Schulen")
...
![Symbolisierung-Menü](/giscurriculum/images/de/module4/media/qgis9.png "Symbolisierung-Menü")
...
![Bevölkerungsdichte im Landkreis Mittelsachsen](/giscurriculum/images/de/module4/media/hrsl-style.png "Bevölkerungsdichte im Landkreis Mittelsachsen")

Abbildung 4.8: Bevölkerungsdichte im Landkreis Mittelsachsen

5.  Zoomen Sie hinein, um die neue Karte feiner zu sehen.

![Vergrößerte Karte](/giscurriculum/images/de/module4/media/zoom-in.png "Vergrößerte Karte")
...
![Der anfängliche Arbeitsbereich](/giscurriculum/images/de/module4/media/initial-workspace.png "Der anfängliche Arbeitsbereich")
...
Unten im Menü befindet sich ein Kontrollkästchen für Zeicheneffekte. Aktivieren Sie dieses, und klicken Sie dann auf die Schaltfläche Effekte einstellen ![](/giscurriculum/images/de/module4/media/customise-effects-button.png "Effekte einstellen") rechts daneben:

![Layereigenschaften-Fenster und Symbologie-Menü](/giscurriculum/images/de/module4/media/draw-effects.png "Layereigenschaften-Fenster und Symbologie-Menü")

Abbildung 4.11: Fenster "Layereigenschaften" und Menü "Symbolisierung"

3. Es öffnet sich ein neuer Effekteigenschaften-Dialog

![Effekteigenschaften-Dialog](/giscurriculum/images/de/module4/media/new-effects-dialog.png "Effekteigenschaften-Dialog")
...
![Effekttyp Verwischen auswählen](/giscurriculum/images/de/module4/media/blur-effect.png "Effekttyp Verwischen auswählen")
...
![Unscharfe Ebene](/giscurriculum/images/de/module4/media/blurry-result.png "Unscharfe Ebene")
...
![Dialog Effekteigenschaften](/giscurriculum/images/de/module4/media/drop-shadow.png "Dialog Effekteigenschaften")
...
![Schlagschatten-Effekt](/giscurriculum/images/de/module4/media/drop-shadow-result.png "Schlagschatten-Effekt")
...
![Zentroid-Operation auf Sachsen-Layer](/giscurriculum/images/de/module4/media/centroid.png "Zentroid-Operation auf Sachsen-Layer")
...
![HRSL-Layer mit Centroid aus dem Vektorlayer](/giscurriculum/images/de/module4/media/centroid-result.png "HRSL-Layer mit Centroid aus dem Vektorlayer")

Abbildung 4.18: HRSL-Layer mit Centroid aus dem Vektorlayer

4. Beachten Sie, dass eine alternative und einfachere Möglichkeit, räumliche Abfragen zu schreiben, die Verwendung des "Ausdrucksdialogs" ist. Klicken Sie auf die ![](/giscurriculum/images/de/module4/media/expression.png "Ausdrucksdialog") Schaltfläche, um das Dialogfeld zu öffnen. Hier haben Sie Zugriff auf eine umfangreiche Funktionsreferenz. Sie können nach einer Funktion anhand ihres Namens suchen. Geben Sie zum Beispiel centroid in die Suchleiste ein.
