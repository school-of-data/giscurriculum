...
![Drucklayout](/giscurriculum/images/de/module5/media/print_comp2.png "Drucklayout")
...
![Exportieren der Karten als Bild](/giscurriculum/images/de/module5/media/export-map-canvas-image.png "Exportieren der Karten als Bild")

![Karte als Bild speichern](/giscurriculum/images/de/module5/media/export-map-canvas.png "Karte als Bild speichern")
...
![Kartenansicht als Bild exportiert](/giscurriculum/images/de/module5/media/exported-map-canvas.png "Kartenansicht als Bild exportiert")
...
![Neues Drucklayout erstellen](/giscurriculum/images/de/module5/media/new-print-layout.png "Neues Drucklayout erstellen")

Abbildung 5.4: Neues Drucklayout erstellen

2. Die Kartenansicht kann nun in das Drucklayout exportiert werden. Klicken Sie dazu auf die Schaltfläche "Neues Drucklayout" !(/giscurriculum/images/de/module5/media/newprint_composer.png "Neues Drucklayout"). Diese kann über die Symbolleiste aufgerufen werden. Alternativ können Sie auch über die Menüleiste "Projekte" darauf zugreifen. Es öffnet sich ein Titeldialog, der Sie auffordert, den Titel des Drucklayouts einzugeben. Geben Sie "Mittelsachsen" ein und klicken Sie auf "OK".

![Benennen des Drucklayouts](/giscurriculum/images/de/module5/media/new-print-layout-name.png "Benennen des Drucklayouts")

Abbildung 5.5: Benennung des Drucklayouts

3. Das Drucklayout wird geöffnet

![Das Drucklayoutfenster](/giscurriculum/images/de/module5/media/new-print-layout-window.png "Das Drucklayoutfenster")

Abbildung 5.6: Das Drucklayoutfenster

4. Sie werden feststellen, dass die Drucklayout-Leinwand leer ist. Um die gestylte Karte aus der QGIS-Leinwand hinzuzufügen, klicken Sie auf die Schaltfläche "Karte hinzufügen" ![](/giscurriculum/images/de/module5/media/add_new_map_to_layout.png), klicken Sie mit der linken Maustaste und zeichnen Sie ein Rechteck in den weißen Bereich in der Mitte des Drucklayouts. Die Karte sollte nun hinzugefügt werden. Nun können Sie alle anderen Kartenelemente wie Titel, Legende, Raster usw. hinzufügen.

![Karte zum Drucklayout hinzufügen](/giscurriculum/images/de/module5/media/print-layout-map.png "Karte zum Drucklayout hinzufügen")
...
1. Klicken Sie auf die Schaltfläche "Beschriftung hinzufügen" ![Beschriftung hinzufügen Button](/giscurriculum/images/de/module5/media/add_title.png "Beschriftung hinzufügen Button")
...
![Kartentitel hinzufügen](/giscurriculum/images/de/module5/media/print-layout-with-title.png "Kartentitel hinzufügen")
...
![Maßstab](/giscurriculum/images/de/module5/media/scale-bar.png "Maßstab")

Abbildung 5.9: Maßstab zur Karte hinzufügen

![Legende](/giscurriculum/images/de/module5/media/legend.png "Legende")

Abbildung 5.9: Legende zur Karte einfügen

![Datenquellen](/giscurriculum/images/de/module5/media/attribution.png)
...
4. Speichern Sie die Karte als Bild über **Layout ‣ Als Bild exportieren...** oder durch Klicken auf die Schaltfläche **Speichern als Rasterbild** ![](/giscurriculum/images/de/module5/media/export-image-btn.png). QGIS wird Sie fragen wo und mit welchen Optionen die Karte gespeichert werden soll.

![Exportparameter](/giscurriculum/images/de/module5/media/img-parameters.png "Exportparameter")

Abbildung 5.10: Exportparameter

![Exportierte Karte als Bild](/giscurriculum/images/de/module5/media/exported-map.png "Exportierte Karte als Bild")
...
![Abdeckungslayer](/giscurriculum/images/de/module5/media/atlas-coverage.png "Abdeckungslayer")

Abbildung 5.12: Abdeckungslayer

![Attributtabelle](/giscurriculum/images/de/module5/media/atlas-attr.png "Attributtabelle")
...
![Atlas Drucklayout](/giscurriculum/images/de/module5/media/atlas-print-layout.png "Atlas Drucklayout")

Abbildung 5.14: Atlas-Drucklayout

3. Wählen Sie dann im rechten Bereich des Drucklayouts das Menü **Atlas** aus und aktivieren Sie das Kontrollkästchen **Einen Atlas generieren**. Sie können die Atlas-Einstellungen auch über die Schaltfläche ![Atlas-Einstellungen](/giscurriculum/images/de/module5/media/atlas-settings-btn.png "Atlas-Einstellungen") in der Atlas-Symbolleiste öffnen.

![Atlas-Generierung](/giscurriculum/images/de/module5/media/generate-atlas.png "Atlas-Generierung")
...
![Abdeckungslayer auswählen](/giscurriculum/images/de/module5/media/coverage-layer.png "Abdeckungslayer auswählen")
...
![Gesteuert durch Atlas](/giscurriculum/images/de/module5/media/atlas-controlled.png "Gesteuert durch Atlas")

Abbildung 5.17: Stellen Sie sicher, dass die Kartenausdehnung durch den Atlas gesteuert wird

5. Um eine Vorschau Ihres Atlas zu erhalten, klicken Sie auf die Schaltfläche Atlas-Vorschau anzeigen ![Atlas-Vorschau anzeigen Button](/giscurriculum/images/de/module5/media/atlas-preview-btn.png "Atlas-Vorschau anzeigen Button") in der Atlas-Symbolleiste. Dies zeigt Ihnen die 13 Karten, die Sie erstellt haben. Verwenden Sie die Atlas-Symbolleiste ![Atlas-Symbolleiste](/giscurriculum/images/de/module5/media/atlas-toolbar-nav.png "Atlas-Symbolleiste"), um in den Atlas-Karten zu navigieren.

![Atlas-Vorschau](/giscurriculum/images/de/module5/media/atlas-preview.png "Atlas-Vorschau")

Abbildung 5.18: Atlas-Vorschau

6. Sie können die Atlas-Karten über die Schaltfläche **Atlas exportieren** ![Atlas exportieren](/giscurriculum/images/de/module5/media/atlas-export-btn.png "Atlas exportieren") entweder als Bild oder als PDF exportieren. Wählen Sie **Atlas als Bild exportieren**. Sie sollten 13 Karten generiert haben, wobei jede Karte die Ausdehnung jedes Landkreises zeigt.

![Atlas-Dateien](/giscurriculum/images/de/module5/media/atlas-outputs.png "Atlas-Dateien")
