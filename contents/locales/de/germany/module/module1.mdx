...
![Karte von Bogota, Kolumbien im Stil von Sternennacht](/giscurriculum/images/de/module1/media/sample-1.jpg "Karte von Bogota, Kolumbien im Stil von Sternennacht")
...
![Sturmspurdaten zwischen 1851 bis 2020](/giscurriculum/images/de/module1/media/sample-2.jpg "Sturmspurdaten zwischen 1851 bis 2020")
...
![Karte der Kerguelen-Insel](/giscurriculum/images/de/module1/media/sample-3.jpg "Karte der Kerguelen-Insel")
...
![Field goal attempts and points scored in UAAP Season 81](/giscurriculum/images/de/module1/media/sample-4.jpg "Field goal attempts and points scored in UAAP Season 81")
...
![QGIS Map Showcase](/giscurriculum/images/de/module1/media/qgis-map-showcase.png "QGIS Map Showcase")
...
![Die QGIS-Oberfläche](/giscurriculum/images/de/module1/media/qgis-interface.png "Die QGIS-Oberfläche")
...
![Teile der QGIS-Oberfläche](/giscurriculum/images/de/module1/media/qgis-interface-parts.png "Teile der QGIS-Oberfläche")
...
![QGIS-Oberfläche mit einigen Anpassungen](/giscurriculum/images/de/module1/media/qgis-interface-custom.png)
...
![QGIS öffnen und auf das Menü Ansicht klicken](/giscurriculum/images/de/module1/media/ex01-01.png "QGIS öffnen und auf das Menü Ansicht klicken")

3. Werfen Sie einen Blick auf das Menü **Bedienfelder**

![Das Menü "Bedienfelder"](/giscurriculum/images/de/module1/media/ex01-02.png)

4. Werfen Sie einen Blick auf das Menü **Werkzeugkästen**

![Das Menü Werkzeugkästen](/giscurriculum/images/de/module1/media/ex01-03.png)
...
1. Richtig oder Falsch:
   1. Sie können mehrere Kartenansichten haben - **_Richtig_**
   2. Sie können Bedienfelder und Werkzeugleisten ein- und ausblenden -- **_Richtig_**
   3. Sie können Panels nur auf der linken oder rechten Seite des Map Canvas platzieren -- **_Falsch (Sie können Panels auch oberhalb oder unterhalb der Kartenansicht platzieren)_**
...
3. Manuelles Hinzufügen des Quellcodes in den Plugins-Ordner Ihres QGIS-Profils. Diesen Ordner finden Sie normalerweise unter:
   ...
   3. **Windows** C:\\Benutzer\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins
      ![Erweiterungen verwalten und installieren Menu](/giscurriculum/images/de/module1/media/plugins-menu.png "Erweiterungen verwalten und installieren Menu")
...
![Dialog "Erweiterungen verwalten und installieren"](/giscurriculum/images/de/module1/media/manage-and-install-plugins-dialog.png "Dialog "Erweiterungen verwalten und installieren"")
...
![Erweiterungen verwalten und installieren](/giscurriculum/images/de/module1/media/plugins-menu-2.png "Dialog zum Verwalten und Installieren von Erweiterungen öffnen")

![Erweiterungen verwalten und installieren](/giscurriculum/images/de/module1/media/manage-and-install-plugins-dialog.png "Erweiterungen verwalten und installieren")
...
![Erweiterungen installieren](/giscurriculum/images/de/module1/media/memory-layer-saver-plugin.png "Memory-Layer-Saver Erweiterung installieren")

- QuickOSM

![QuickOSM-Plugin installieren](/giscurriculum/images/de/module1/media/quickosm-plugin.png "QuickOSM-Erweiterung installieren")
...
1. Richtig oder Falsch
   1. Sie können Erweiterungen des QGIS-Kerns entfernen oder deinstallieren -- **_Falsch_**
   2. Sie können Erweiterungen hinzufügen, die sich nicht im offiziellen QGIS Plugin Repository befinden -- **_Richtig_**
...
![Die Systemeinstellungen](/giscurriculum/images/de/module1/media/settings-1.png "Die Systemeinstellungen")

Abbildung 1.7. Die Systemeinstellungen

![Projekt-Einstellungen](/giscurriculum/images/de/module1/media/settings-2.png "Projekt-Einstellungen")
...
![Allgemeine Einstellungen von QGIS](/giscurriculum/images/de/module1/media/change-theme.png "Allgemeine Einstellungen von QGIS")
...
![Benutzerprofile aufrufen](/giscurriculum/images/de/module1/media/user-profiles-1.png "Benutzerprofile aufrufen")
...
![alt_text](/giscurriculum/images/de/module1/media/user-profiles-2.png "image_tooltip")

2. Geben Sie Ihrem neuen Benutzerprofil einen Namen.

![alt_text](/giscurriculum/images/de/module1/media/user-profiles-3.png "image_tooltip")
...
1. Richtig oder Falsch
   1. Sie können nur ein Benutzerprofil in QGIS haben. -- **_Falsch (Sie können mehrere Benutzerprofile haben)_**
   2. Sie können die Systemeinstellungen und -eigenschaften nicht überschreiben. -- **_Falsch_**
