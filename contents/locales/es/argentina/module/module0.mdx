...
- Una introducción suave a los conceptos de SIG - [https://docs.qgis.org/3.16/es/docs/gentle_gis_introduction/index.html](https://docs.qgis.org/3.16/es/docs/gentle_gis_introduction/index.html)
- Guía del Usuario de QGIS- [https://docs.qgis.org/3.16/es/docs/user_manual/](https://docs.qgis.org/3.16/es/docs/user_manual/)
- QGIS - [https://docs.qgis.org/3.16/es/docs/training_manual/index.html](https://docs.qgis.org/3.16/es/docs/training_manual/index.html)
- Sitio web de QGIS - [https://qgis.org/es/site/](https://qgis.org/es/site/)
- Sitio web de OSGeo - [https://www.osgeo.org/](https://www.osgeo.org/)
- Sitio web de OSGeoLive - [https://live.osgeo.org/es/index.html](https://live.osgeo.org/es/index.html)
...
SIG* no es solo mapeo.* Aunque la elaboración de mapas es uno de los aspectos más importantes y comúnmente conocidos de los SIG, sigue siendo solo una de sus muchas partes y características. Podemos ver el marco SIG moderno como compuesto por:
...
Si deseas probar rápidamente el uso de aplicaciones FOSS4G, puedes probar OSGeoLive ([https://live.osgeo.org/es/index.html](https://live.osgeo.org/es/index.html)), que es una distribución de Linux (sistema operativo) que viene preinstalado con QGIS, GRASS, y otras aplicaciones de FOSS4G.
...
[^1]: N de T: en Inglés, “free” puede significar “libre” o “gratuito”. Esta frase quiere decir _“Libre como la libertad, no comida gratis”_.
